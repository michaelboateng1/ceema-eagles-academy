...
export async function POST({ request }) {
	const { fullName, email, number, childName, message } = await request.json();
	...
	const body = `<!DOCTYPE html>
                    ...
                    <title>New Contact Message - Ceema Eagles Academy</title>
                    </head>
                    <body style="margin:0;padding:0;background-color:#e07b1c;font-family:Arial, Helvetica, sans-serif;font-size:18px;">

                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#e07b1c;padding:24px 0;">
                        <tr>
                        <td align="center">
                            ...
                            <tr>
                                ...
                                <h1 style="margin:0;font-size:22px;letter-spacing:0.5px;">New Contact Message From ${fullName}</h1>
                            ...
                            <tr>
                                ...
                                <table width="100%" cellpadding="8" cellspacing="0" border="0" style="border-collapse:collapse;border:1px solid #e5e7eb;border-radius:6px;">
                                    ...
                                    <td style="border-bottom:1px solid #e5e7eb;">${fullName}</td>
                                    </tr>
                                    <tr>
                                    <td style="background:#f9fafb;font-weight:bold;border-bottom:1px solid #e5e7eb;">Email Address</td>
                                    <td style="border-bottom:1px solid #e5e7eb;">${email}</td>
                                    </tr>
                                    <tr>
                                    <td style="background:#f9fafb;font-weight:bold;border-bottom:1px solid #e5e7eb;">Children Name</td>
                                    <td style="border-bottom:1px solid #e5e7eb;">${childName}</td>
                                    </tr>
                                    <tr>
                            ...
                            <tr>
                                ...
                                <p style="font-size:12px;color:#6b7280;margin:0;">
                                    © 2025 Ceema Eagles Academy. All rights reserved.
                                </p>
                                </td>
                            </tr>
                            </table>
