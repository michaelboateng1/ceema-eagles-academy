<script>
    ...
    import ProgramsCard from "../components/ProgramsCard.svelte";

    import {ourPrograms} from "$lib/index"

    const page = "Our Programs"
</script>

<Header {page} />
<main>
    <IntroText>
        <h1 class="uppercase font-bold mb-5 text-lg sm:text-2xl text-[#e07b1c]">Beyond the basics</h1>
