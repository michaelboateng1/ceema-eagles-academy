...
<section class="flex items-start justify-start container h-auto sm:h-[300px] mx-auto mb-20  mt-50  sm:px-30">
    ...
    <div class="bg-[#e07b1c] h-full text-white p-5 sm:p-10">
        <p class="sm:pl-20 pt-16 italic">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aut, enim numquam cum voluptate incidunt nobis voluptates ex. Soluta, perspiciatis consequuntur.</p>

        <div class="px-10 pb-10 sm:pb-0 mt-10">
